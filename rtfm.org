...
*** compat
  ...
  (when (version< emacs-version "25")
    ...
    FUNCTION must be a one-argument function, and SEQUENCE may be a list, vector, or string."
        (cond
         ((listp sequence)
      ...
      (defun seq-map (function sequence)
        "Apply FUNCTION to each element of SEQUENCE and return a sequence of the same type.
    SEQUENCE may be a list, vector, or string."
        (cond
         ((listp sequence)
